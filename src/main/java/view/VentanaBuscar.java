...
public class VentanaBuscar extends javax.swing.JFrame {
    ...
    public void cedulaVacia() {
        JOptionPane.showMessageDialog(null, "No hay cedula que consultar", "CAMPO CEDULA VACIO",
                JOptionPane.ERROR_MESSAGE);
    }

    public void radiosVacios() {
        JOptionPane.showMessageDialog(null, "Para consultar una persona, escoja su situacion militar",
                "SITUACION MILITAR SIN SELECCIONAR", JOptionPane.ERROR_MESSAGE);
    }

    public void listaVacia(String cadena) {
        JOptionPane.showMessageDialog(null, "No hay " + cadena + " para consultar", "NO HAY PERSONAS EN EL SISTEMAS",
                JOptionPane.ERROR_MESSAGE);
    }

    public void personaNoExiste() {
        JOptionPane.showMessageDialog(null, "Esta persona no esta en la base de datos", "NO EXISTE",
                JOptionPane.ERROR_MESSAGE);
    }

    public void tieneOtraSituacion() {
        JOptionPane.showMessageDialog(null, "Esta persona no tiene la situacion militar seleccionada",
                "SITUACION MILITAR NO COINCEDENTE", JOptionPane.ERROR_MESSAGE);
    }
}
